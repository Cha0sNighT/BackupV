...
AddEventHandler('esx:giveInventoryItem', function(target, type, itemName, itemCount)
  ...
  elseif type == 'item_money' then
    ...
    if itemCount > 0 and sourceXPlayer.player.get('money') >= itemCount then
      ...
      TriggerClientEvent('esx:showNotification', _source, _U('yougave') .. ' ~g~$' .. itemCount .. _U('to')   .. _U('front_of'))
      TriggerClientEvent('esx:showNotification', target,  _U('youreceived') .. ' ~g~$'  .. itemCount .. _U('by') .._U('front_of'))
  ...
  elseif type == 'item_account' then
    ...
    if itemCount > 0 and sourceXPlayer.getAccount(itemName).money >= itemCount then
      ...
      TriggerClientEvent('esx:showNotification', _source, _U('yougave') .. ' [' .. Config.AccountLabels[itemName] .. '] ~g~$' .. itemCount .. _U('to')   .. _U('front_of'))
      TriggerClientEvent('esx:showNotification', target,  _U('youreceived') .. ' ['  .. Config.AccountLabels[itemName] .. '] ~g~$' .. itemCount .. _U('by') .. _U('front_of'))
  ...
  elseif type == 'item_weapon' then
    ...
    TriggerClientEvent('esx:showNotification', _source, _U('yougave') .. ' x1 ~g~' .. weaponLabel .. _U('to')   .. _U('front_of'))
    TriggerClientEvent('esx:showNotification', target,  _U('youreceived')  .. ' x1 ~g~' .. weaponLabel .. _U('by') .. _U('front_of'))
