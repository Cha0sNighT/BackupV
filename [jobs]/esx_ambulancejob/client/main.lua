    ...
    function(data, menu)
      ...
      if player ~= -1 and distance <= 3.0 then
        ...
        if amount == nil then
            ...
            TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(player), 'society_ambulance', _U('facture'), amount)
        end
  ...
  ESX.UI.Menu.Open(
    'default', GetCurrentResourceName(), 'mobile_ambulance_actions',
    {
      ...
      elements = {
        ...
        {label = _U('billing'),  value = 'facture'}
      },
    },
    function(data, menu)
...
AddEventHandler('esx_ambulancejob:hasEnteredMarker', function(zone)
  ...
  if zone == 'HospitalInteriorExit1' then
    TeleportFadeEffect(GetPlayerPed(-1), Config.Zones.HospitalInteriorOutside1.Pos,75.5)
  end
