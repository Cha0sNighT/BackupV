Locales['fr'] = {
  ...
  ['shop_menu'] = 'Appuyez sur ~INPUT_CONTEXT~ Provisions Foodtruck',
  ['shop'] = 'Provisions',
  ['bought'] = 'Vous avez acheté ',
  ['max_item'] = 'Vous avez atteint la limite',
  ['not_enough'] = "Pas assez d'argent sur le compte société",
