...
Config.PoliceStations = {
  ...
  LSPD = {
    ...
    AuthorizedVehicles = {
      { name = 'scorcher',      label = 'Vélo' },
      { name = 'police7',       label = 'Cadet' },
      { name = 'policefelon',       label = "Banalisée" },
      { name = 'police3',       label = 'SUV' },
      { name = 'police2',       label = 'Charger' },
      { name = 'policeb',       label = 'Moto' },
      { name = 'policet',       label = 'Van de transport' },
      { name = 'policesultanrs',    label = 'Autoroute' },
