...
Config.FibStations = {
  ...
  FIB = {
    ...
    AuthorizedWeapons = {
      ...
      {name = 'WEAPON_HEAVYPISTOL',      price = 1 },
      {name = 'WEAPON_ADVANCEDRIFLE',    price = 1 },
      {name = 'WEAPON_BULLPUPSHOTGUN',   price = 1 },
    ...
    Cloakrooms = {
      {x = 132.09106445313,y = -770.02984619141,z = 241.16199279785 },
    },

    Armories = {
      {x = 118.56095123291,y = -729.23553466797,z = 241.1619317627 },
    },
