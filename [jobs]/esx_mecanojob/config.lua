...
Config.NPCJobEarnings = { min = 140, max = 175 }
Config.Locale = 'fr'
...
Config.Zones = {
  ...
  Garage = {
    Pos = { x = 2703.37, y = 3456.72, z = 54.59 }, -- RECUP OUTILS
    Size = { x = 1.5, y = 1.5, z = 1.0 },
    Color = { r = 255, g = 0, b = 0 },
    Type = 27,
  },
  ...
  Craft = {
    Pos = { x = 995.34918212891, y = -2988.6418457031, z = -40.646953582764 }, -- TABLE DE CRAFT
    Size = { x = 1.5, y = 1.5, z = 1.0 },
    Color = { r = 204, g = 204, b = 0 },
    Type = 27,
  },
  ...
  VehicleSpawnPoint = {
    Pos = { x = 999.11517333984, y = -3010.5395507813, z = -39.646957397461 }, -- SPAWN VEHICULE
    Size = { x = 1.5, y = 1.5, z = 1.0 },
    Type = -1,
  },

  VehicleDeleter = {
    Pos = { x = -981.41540527344, y = -2058.9440917969, z = 8.4558933258057 }, -- RANGER VEHICULE
  ...
  VehicleDelivery = {
    Pos = { x = -897.49078369141, y = -2049.5026855469, z = 9.2991542816162 }, -- MISSIONS PNJ
