            ...
            ESX.TriggerServerCallback('esx_society:getVehiclesInGarage', function(vehicles)
              ...
              ESX.UI.Menu.Open(
                ...
                function(data, menu)
                  ...
                  ESX.Game.SpawnVehicle(vehicleProps.model, Config.Zones.VehicleSpawnPoint.Pos, 60.383274, function(vehicle)
...
Citizen.CreateThread(function()
    while true do
        ...
        if IsControlJustReleased(0, Keys['=']) and PlayerData.job ~= nil and PlayerData.job.name == 'mecano' then
