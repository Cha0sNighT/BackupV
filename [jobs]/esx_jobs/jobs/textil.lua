Config.Jobs.textil = {
	...
	Zones = {
		CloakRoom = {
			Pos   = {x = 706.735412597656, y = -960.902893066406, z = 29.4053247070313},
		...
		Whool = {
			Pos   = {x = 1978.92407226563, y = 5171.70166015625, z = 46.6491181945801},
			Size  = {x = 3.0, y = 3.0, z = 1.0},
			Color = {r = 204, g = 204, b = 0},
			Marker= 27,
			Blip  = true,
		...
		Fabric = {
			Pos   = {x = 715.954650878906, y = -959.639587402344, z = 29.4053247070313},
			Size  = {x = 3.0, y = 3.0, z = 1.0},
			Color = {r = 204, g = 204, b = 0},
			Marker= 27,
			Blip  = true,
		...
		Clothe = {
			Pos   = {x = 712.928283691406, y = -970.5869140625, z = 29.4053247070313},
			Size  = {x = 3.0, y = 3.0, z = 1.0},
			Color = {r = 204, g = 204, b = 0},
			Marker= 27,
			Blip  = true,
		...
		VehicleSpawner = {
			Pos   = {x = 740.808776855469, y = -970.066650390625, z = 23.4793908691406},
			Size  = {x = 3.0, y = 3.0, z = 1.0},
			Color = {r = 204, g = 204, b = 0},
			Marker= 27,
			Blip  = false,
		...
		VehicleDeletePoint = {
			Pos   = {x = 693.796325683594, y = -963.010498046875, z = 22.8347337341309},
			Size  = {x = 3.0, y = 3.0, z = 1.0},
			Color = {r = 255, g = 0, b = 0},
			Marker= 27,
			Blip  = false,
		...
		Delivery = {
			Pos   = {x = 429.595855712891, y = -807.341613769531, z = 28.5011441802979},
			Color = {r = 204, g = 204, b = 0},
			Size  = {x = 5.0, y = 5.0, z = 3.0},
			Marker= 27,
			Blip  = true,
			Name  = _U('dd_deliver_clothes_blip'),
			Type  = "delivery",
			Spawner = 1,
			Item  = {
				{
