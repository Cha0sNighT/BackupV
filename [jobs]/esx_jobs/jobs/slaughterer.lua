Config.Jobs.slaughterer = {
	...
	Zones = {
		CloakRoom = {
			Pos   = {x = -1071.1319580078, y = -2003.7891845703, z = 14.79551197052},
		...
		AliveChicken = {
			Pos   = {x = -62.9018, y = 6241.46, z = 30.1001},
			Size  = {x = 3.0, y = 3.0, z = 1.0},
			Color = {r = 204, g = 204, b = 0},
			Marker= 27,
			Blip  = true,
		...
		SlaughterHouse = {
			Pos   = {x = -77.991, y = 6229.063, z = 30.101},
			Size  = {x = 3.0, y = 3.0, z = 1.0},
			Color = {r = 204, g = 204, b = 0},
			Marker= 27,
			Blip  = true,
		...
		Packaging = {
			Pos   = {x = -101.978, y = 6208.799, z = 30.035},
			Size  = {x = 3.0, y = 3.0, z = 1.0},
			Color = {r = 204, g = 204, b = 0},
			Marker= 27,
			Blip  = true,
		...
		VehicleSpawner = {
			Pos   = {x = -1063.5012207031, y = -2018.2877197266, z = 12.1715858078},
			Size  = {x = 3.0, y = 3.0, z = 1.0},
			Color = {r = 204, g = 204, b = 0},
			Marker= 27,
			Blip  = false,
		...
		VehicleDeletePoint = {
			Pos   = {x = -1061.5164794922, y = -2008.3552246094, z = 12.171584854126},
		...
		Delivery = {
			Pos   = {x = -596.158, y = -889.324, z = 24.5173},
			Color = {r = 204, g = 204, b = 0},
			Size  = {x = 5.0, y = 5.0, z = 1.0},
			Marker= 27,
			Blip  = true,
			Name  = _U('s_deliver_blip'),
			Type  = "delivery",
			Spawner = 1,
			Item  = {
				{
