Config.Jobs.fuel = {
	...
	Zones = {
		CloakRoom = { -- 1
			Pos   = {x = 557.933, y = -2327.9, z = 4.84896},
		...
		ChampPetrol = { -- 4 -- 8
			Pos   = {x = 609.589, y = 2856.74, z = 39.5058},
		...
		Raffinerie = { -- 5
			Pos   = {x = 2736.94, y = 1417.99, z = 23.4988},
		...
		Melange = { -- 6
			Pos   = {x = 265.752, y = -3013.39, z = 4.74275},
			Size  = {x = 10.0, y = 10.0, z = 1.0},
			Color = {r = 204, g = 204, b = 0},
			Marker= 27,
			Blip  = true,
		...
		VehicleSpawner = { -- 2
			Pos   = {x = 554.597, y = -2314.43, z = 4.87293},
			Size  = {x = 3.0, y = 3.0, z = 2.0},
			Color = {r = 204, g = 204, b = 0},
			Marker= 27,
			Blip  = false,
		...
		VehicleDeletePoint = {
			Pos   = {x = 520.684, y = -2124.21, z = 4.99635},
		...
		Delivery = { -- 7
			Pos   = {x = 491.406, y = -2163.37, z = 4.92827},
			Color = {r = 204, g = 204, b = 0},
			Size  = {x = 10.0, y = 10.0, z = 1.0},
			Marker= 27,
			Blip  = true,
			Name  = _U('f_deliver_gas_blip'),
			Type  = "delivery",
			Spawner = 1,
			Item  = {
				{
