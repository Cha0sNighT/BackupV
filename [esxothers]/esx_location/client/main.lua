...
function OpenVehicleMenu() -- Menu location véhicules
    ...
    local elements = {
        {label = 'Kalahari', value = 'kalahari', price = 0}, -- Véhicule n°1
        {label = 'Faggio', value = 'faggio3', price = 0} -- Véhicule n°4
    }
    ...
    ESX.UI.Menu.Open(
        ...
        function(data, menu)
            for i=1, #elements, 1 do
                ...
                ESX.Game.SpawnVehicle(data.current.value, coords, 150.57035, function(vehicle)
