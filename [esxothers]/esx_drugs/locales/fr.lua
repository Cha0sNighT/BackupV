Locales['fr'] = {
	...
	['press_collect_opium'] = "appuyez sur ~INPUT_CONTEXT~ pour créer des faux papiers",
    ['press_process_opium'] = "appuyez sur ~INPUT_CONTEXT~ pour empaqueter les faux papiers",
    ['press_sell_opium'] = "appuyez sur ~INPUT_CONTEXT~ pour vendre les faux papiers",
    ...
    ['too_many_pouches'] = 'vous êtes trop chargé',
    ...
    ['not_enough_opium'] = 'vous n\'avez pas assez de faux papier pour ~r~empaqueter~s~',
    ['sold_one_opium'] = 'vous avez vendu ~g~x1 Carton de faux papiers~s~',
    ['used_one_opium'] = 'Vous avez utilisé 1 Carton de ~b~faux papiers',
